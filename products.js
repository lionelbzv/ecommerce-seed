...
exports.populateProducts = void 0;
        ...
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    database_1.pool.getConnection(function (err, connection) {
                        ...
                        var deleteQuery = 'DELETE FROM sylius_product';
                        connection.query(deleteQuery, function (error, results, fields) {
                            if (error) {
                                reject(error);
                                return;
                            }
                            var resetQuery = 'ALTER TABLE sylius_product AUTO_INCREMENT = 1';
                            connection.query(resetQuery, function (error, results, fields) {
                                if (error) {
                                    reject(error);
                                    return;
                                }
                                var productInsertQueries = new Array();
                                var _loop_1 = function (i) {
                                    ...
                                    var insertProductPromise = new Promise(function (resolve, reject) {
                                        connection.query(insertProductQuery, product, function (error, results, fields) {
                                            if (error) {
                                                reject(error);
                                                return;
                                            }
