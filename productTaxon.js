...
exports.populateProductTaxon = void 0;
 ...
 */
function populateProductTaxon(productIds, taxonIds) {
        ...
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    database_1.pool.getConnection(function (err, connection) {
                        ...
                        var productTaxonIds = new Array();
                        var deleteQuery = 'DELETE FROM sylius_product_taxon';
                        connection.query(deleteQuery, function (error, results, fields) {
                            if (error) {
                                reject(error);
                                return;
                            }
                            var resetQuery = 'ALTER TABLE sylius_product_taxon AUTO_INCREMENT = 1';
                            connection.query(resetQuery, function (error, results, fields) {
                                if (error) {
                                    reject(error);
                                    return;
                                }
                                var productTaxonInsertQueries = new Array();
                                var _loop_1 = function (i) {
                                    ...
                                    var insertProductTaxonPromise = new Promise(function (resolve, reject) {
                                        connection.query(insertProductTaxonQuery, productTaxon, function (error, results, fields) {
                                            if (error) {
                                                reject(error);
                                                return;
                                            }
...
exports.populateProductTaxon = populateProductTaxon;
